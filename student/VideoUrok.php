...
<body class="container">
    <header>
        <div class="nav-bar">
            ...
            <a href="http://localhost/15/your_project_folder/student/lesson_Html2.php">Выход</a>
    ...
    <main>
        <style>
            ...
            .message {
                ...
                padding: 10px;
                background-color:
                    <?= isset($result_message) && strpos($result_message, 'Ошибка') === false ? '#d4edda' : '#f8d7da' ?>
                ;
                color:
                    <?= isset($result_message) && strpos($result_message, 'Ошибка') === false ? '#155724' : '#721c24' ?>
                ;
                border-radius: 4px;
            }
        </style>
